...
def random_walk_wo_wall(model):
    ...
    # print("Action")
    # print(action_one_hot_value.shape)
    # print("Position")
    # print(position.shape)
    # print("Action selection")
    # print(action_selection.shape)
    ###############################################
    #print("action one hot value")
    #print(action_one_hot_value.shape)
    #print(action_one_hot_value[0][0])

    # print("position")
    # print(position[0])
    # print("action selection")
    # print(action_selection[0])
