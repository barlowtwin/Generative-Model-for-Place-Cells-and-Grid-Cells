...
def main():
    ...
    training_dataset = dset.ImageFolder(root='./datasets/training', transform=data_transform)
    loader_train = DataLoader(training_dataset, batch_size=args.batch_size, shuffle=True, **kwargs)

    val_dataset = dset.ImageFolder(root='./datasets/val', transform=data_transform)
